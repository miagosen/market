...
public abstract class DownloadState {
   ...
   * @param state     ： 状态值
   * @param pkgname   ： 下载的包名
   * @param errorCode : 错误状态，中止的时候
   */
  public abstract void onDownloadState (int state, String pkgname, int errorCode);
   ...
   */
  public abstract void updateDownloadProgress (String pkgname, int downloadFileSize, int downloadPosition);
}
