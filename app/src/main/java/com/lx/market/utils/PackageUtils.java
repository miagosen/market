...
public class PackageUtils {
   ...
   * @param filePath file path of package
   * @return {@link com.lx.market.utils.PackageUtils#INSTALL_SUCCEEDED} means install success,
   * other means failed. details see
   * {@link com.lx.market.utils.PackageUtils#*}
   */
  ...
  public static synchronized boolean uninstallNormal (Context context, String packageName) {
	...
	Intent i = new Intent(Intent.ACTION_DELETE, Uri.parse(new StringBuilder(64).append("package:")
   ...
   * @param packageName package name of app
   * @return
   * @see {@link #uninstallSilent(android.content.Context, String, boolean)}
   */
