...
public class HttpUtils {
  ...
  public HttpHandler<File> download (String url, String target,
									 boolean autoResume, String MD5, RequestCallBack<File> callback) {
	return download(HttpRequest.HttpMethod.GET, url, target, null, autoResume, false, MD5, callback);
  }
  ...
  public synchronized HttpHandler<File> download (HttpRequest.HttpMethod method, String url, String target,
												  RequestParams params, boolean autoResume, boolean autoRename, String md5, RequestCallBack<File> callback) {
	...
	handler.executeOnExecutor(EXECUTOR, request, target, autoResume, autoRename, md5);
	return handler;
  }
